...
//        }
    ...
    public function vod()
    {
        ...
        if (empty($html) || $cache_time == 0) {
            ...
            if (!empty($this->_param['t'])) {
                if (empty($GLOBALS['config']['api']['vod']['typefilter']) || strpos($GLOBALS['config']['api']['vod']['typefilter'],
                        $this->_param['t']) !== false) {
            ...
            $res = model('Vod')->listData($where, $order, $this->_param['pg'],
    ...
    public function vod_xml($res)
    {
        ...
        foreach ($res['list'] as $k => &$v) {
            ...
            } elseif (!empty($v["vod_pic"]) && substr($v["vod_pic"], 0, 4) != "http" && substr($v["vod_pic"], 0,
                    2) != "//") {
                $v["vod_pic"] = $GLOBALS['config']['api']['vod']['imgurl'].$v["vod_pic"];
            }

            if ($this->_param['ac'] == 'videolist' || $this->_param['ac'] == 'detail') {
                $tempurl = $this->vod_url_deal($v["vod_play_url"], $v["vod_play_from"],
    ...
    public function vod_url_deal($urls, $froms, $from, $flag)
    {
        ...
        $res = str_replace([chr(10), chr(13)], ['', '#'], $res_xml);
    ...
    public function art()
    {
        ...
        if (empty($html) || $cache_time == 0) {
            ...
            if (!empty($this->_param['t'])) {
                if (empty($GLOBALS['config']['api']['art']['typefilter']) || strpos($GLOBALS['config']['api']['art']['typefilter'],
                        $this->_param['t']) !== false) {
                    $where['type_id'] = $this->_param['t'];
                }
            }
            ...
            $res = model('Art')->listData($where, $order, $this->_param['pg'],
                $GLOBALS['config']['api']['art']['pagesize'], 0, $field, 0);
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                } elseif (!empty($v["art_pic"]) && substr($v["art_pic"], 0, 4) != "http" && substr($v["art_pic"], 0,
                        2) != "//") {
    ...
    public function actor()
    {
        ...
        if (empty($html) || $cache_time == 0) {
            ...
            if (!empty($this->_param['t'])) {
                if (empty($GLOBALS['config']['api']['actor']['typefilter']) || strpos($GLOBALS['config']['api']['actor']['typefilter'],
                        $this->_param['t']) !== false) {
                    $where['type_id'] = $this->_param['t'];
                }
            }
            ...
            $res = model('Actor')->listData($where, $order, $this->_param['pg'],
                $GLOBALS['config']['api']['actor']['pagesize'], 0, $field, 0);
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                } elseif (!empty($v["actor_pic"]) && substr($v["actor_pic"], 0, 4) != "http" && substr($v["actor_pic"],
                        0, 2) != "//") {
    ...
    public function role()
    {
        ...
        if (empty($html) || $cache_time == 0) {
            ...
            if (!empty($this->_param['t'])) {
                if (empty($GLOBALS['config']['api']['role']['typefilter']) || strpos($GLOBALS['config']['api']['role']['typefilter'],
                        $this->_param['t']) !== false) {
                    $where['type_id'] = $this->_param['t'];
                }
            }
            ...
            $res = model('Role')->listData($where, $order, $this->_param['pg'],
                $GLOBALS['config']['api']['role']['pagesize'], 0, $field, 1);
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                } elseif (!empty($v["role_pic"]) && substr($v["role_pic"], 0, 4) != "http" && substr($v["role_pic"], 0,
                        2) != "//") {
    ...
    public function website()
    {
        ...
        if (empty($html) || $cache_time == 0) {
            ...
            if (!empty($this->_param['t'])) {
                if (empty($GLOBALS['config']['api']['website']['typefilter']) || strpos($GLOBALS['config']['api']['website']['typefilter'],
                        $this->_param['t']) !== false) {
                    $where['type_id'] = $this->_param['t'];
                }
            }
            ...
            $res = model('Website')->listData($where, $order, $this->_param['pg'],
                $GLOBALS['config']['api']['website']['pagesize'], 0, $field, 0);
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                } elseif (!empty($v["website_pic"]) && substr($v["website_pic"], 0,
                        4) != "http" && substr($v["website_pic"], 0, 2) != "//") {
