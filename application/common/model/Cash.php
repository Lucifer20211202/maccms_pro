...
class Cash extends Base
{
    ...
    public function saveData($param)
    {
        ...
        if ($data['cash_money'] < $GLOBALS['config']['user']['cash_min']) {
            return [
                'code' => 1006, 'msg' => lang('model/cash/min_money_err').'：'.$GLOBALS['config']['user']['cash_min']
            ];
        }
    ...
    public function createTableIfNotExists()
    {
        ...
        // 1
        $this->checkAndAlterTableField('cash_no',
            "ADD `cash_no` varchar(64) NOT NULL DEFAULT '' COMMENT '提现单号' AFTER `cash_id`");
    }
