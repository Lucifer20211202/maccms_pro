...
class Extend extends Base
{
    ...
    public function areaData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('area_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);

        return [
            'code' => 1, 'msg' => lang('data_list'), 'page' => 1, 'limit' => $num, 'total' => $total, 'list' => $list
        ];
    }
    ...
    public function langData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('lang_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
    ...
    public function classData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('class_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
    ...
    public function yearData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('year_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
    ...
    public function versionData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('version_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
    ...
    public function stateData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('state_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
    ...
    public function letterData($lp)
    {
        ...
        $cach_name = $GLOBALS['config']['app']['cache_flag'].'_'.md5('letter_listcache_'.join('&',
                    $lp).'_'.$order.'_'.$num.'_'.$start);
